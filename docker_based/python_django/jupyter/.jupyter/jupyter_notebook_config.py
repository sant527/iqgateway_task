import os
if os.environ['JUPYTER_PASS'] == "1":
	c.NotebookApp.password = u'argon2:$argon2id$v=19$m=10240,t=10,p=8$Lp24x6kMhnQRle8wK96kOg$Sts/nWFaTC6H+jlMnbQLPQ'
else:
	c.NotebookApp.password = u'argon2:$argon2id$v=19$m=10240,t=10,p=8$Lp24x6kMhnQRle8wK96kOg$Sts/nWFaTC6H+jlMnbQLPQ'
...
#  Choices: any of ['sha3_256', 'sha3_512', 'sha3_224', 'sha224', 'sha256', 'blake2s', 'sha3_384', 'sha384', 'sha512', 'blake2b', 'md5', 'sha1']
#  Default: 'sha256'
